...
## 論文  
+ 口頭発表（査読なし）  
  - 武田 悠佑, 岩田具治, 澤田宏: [多様なノイズに頑健な関係データのクラスタリング](http://db-event.jpn.org/deim2018/data/papers/68.pdf), 電子情報通信学会 データ工学研究専門委員会 他共催, 第10回データ工学と情報マネジメントに関するフォーラム DEIM2018, F5-5, 清風荘 (Mar. 4 - 6, 2018).  
